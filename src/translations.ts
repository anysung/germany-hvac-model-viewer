...
const EN_T = {
    ...
    // ── Subscribe-required gate (day 8) ──
    subReqTitle: "Your free access has ended",
    subReqBodyTrialEnded: "Your 7-day free trial is over. Subscribe to continue using the full database.",
    ...
    verifiedSignIn: "Email confirmed. Sign in to start your 7-day trial.",
    suErrEmailMatch: "The two email addresses do not match.",
    suEmailConfirm: "Confirm email",
    ...
    socialLoginOnly: "Connect Google & Apple at Account page before use",
    ...
    suEmailAdvice: "A company email is recommended. The account email cannot be changed later — team seats and invoices are tied to it. After signing up you can link Google or Apple sign-in from your Account page.",
...
const DE_T = {
    ...
    subReqBodyTrialEnded: "Ihre 7-tägige Testphase ist abgelaufen. Abonnieren Sie, um die vollständige Datenbank weiter zu nutzen.",
    ...
    verifiedSignIn: "E-Mail bestätigt. Melden Sie sich an, um Ihre 7-tägige Testphase zu starten.",
    suErrEmailMatch: "Die beiden E-Mail-Adressen stimmen nicht überein.",
    suEmailConfirm: "E-Mail bestätigen",
    ...
    socialLoginOnly: "Google & Apple vorher auf der Konto-Seite verknüpfen",
    ...
    suEmailAdvice: "Eine Firmen-E-Mail wird empfohlen. Die Konto-E-Mail lässt sich später nicht ändern — Teamplätze und Rechnungen sind damit verknüpft. Nach der Registrierung können Sie die Google- oder Apple-Anmeldung in Ihrem Konto hinzufügen.",
...
const FR_T = {
    ...
    subReqBodyTrialEnded: "Votre essai gratuit de 7 jours est terminé. Abonnez-vous pour continuer à utiliser la base de données complète.",
    ...
    verifiedSignIn: "E-mail confirmé. Connectez-vous pour démarrer votre essai de 7 jours.",
    suErrEmailMatch: "Les deux adresses e-mail ne correspondent pas.",
    suEmailConfirm: "Confirmer l'e-mail",
    ...
    socialLoginOnly: "Associez Google et Apple sur la page Compte avant utilisation",
    ...
    suEmailAdvice: "Un e-mail professionnel est recommandé. L\u2019adresse du compte ne peut pas être modifiée par la suite — les sièges d\u2019équipe et les factures y sont rattachés. Après l\u2019inscription, vous pourrez associer la connexion Google ou Apple depuis votre page Compte.",
...
const PL_T = {
    ...
    subReqBodyTrialEnded: "Twój 7-dniowy okres próbny się zakończył. Wykup subskrypcję, aby dalej korzystać z pełnej bazy danych.",
    ...
    verifiedSignIn: "Adres e-mail potwierdzony. Zaloguj się, aby rozpocząć 7-dniowy okres próbny.",
    suErrEmailMatch: "Podane adresy e-mail nie są takie same.",
    suEmailConfirm: "Potwierdź adres e-mail",
    ...
    socialLoginOnly: "Najpierw połącz Google i Apple na stronie Konto",
    ...
    suEmailAdvice: "Zalecamy firmowy adres e-mail. Adresu konta nie można później zmienić — są z nim powiązane miejsca w zespole i faktury. Po rejestracji w zakładce Konto możesz połączyć logowanie Google lub Apple.",
...
const IT_T = {
    ...
    subReqBodyTrialEnded: "La tua prova gratuita di 7 giorni è terminata. Abbonati per continuare a usare il database completo.",
    ...
    verifiedSignIn: "E-mail confermata. Accedi per iniziare la prova di 7 giorni.",
    suErrEmailMatch: "I due indirizzi e-mail non coincidono.",
    suEmailConfirm: "Conferma e-mail",
    ...
    socialLoginOnly: "Collega Google e Apple nella pagina Account prima dell\u2019uso",
    ...
    suEmailAdvice: "Si consiglia un\u2019e-mail aziendale. L\u2019indirizzo dell\u2019account non può essere modificato in seguito — postazioni del team e fatture sono collegate a questo indirizzo. Dopo la registrazione puoi collegare l\u2019accesso Google o Apple dalla pagina Account.",
