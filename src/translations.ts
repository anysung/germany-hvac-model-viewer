...
const EN_T = {
    ...
    verifiedSignIn: "Registration complete — your email address is confirmed. Sign in to start your 7-day trial.",
...
const DE_T = {
    ...
    verifiedSignIn: "Registrierung abgeschlossen — Ihre E-Mail-Adresse ist bestätigt. Melden Sie sich an, um Ihre 7-tägige Testphase zu starten.",
...
const FR_T = {
    ...
    verifiedSignIn: "Inscription terminée — votre adresse e-mail est confirmée. Connectez-vous pour démarrer votre essai de 7 jours.",
...
const PL_T = {
    ...
    verifiedSignIn: "Rejestracja zakończona — adres e-mail został potwierdzony. Zaloguj się, aby rozpocząć 7-dniowy okres próbny.",
...
const IT_T = {
    ...
    verifiedSignIn: "Registrazione completata — il tuo indirizzo e-mail è confermato. Accedi per iniziare la prova di 7 giorni.",
