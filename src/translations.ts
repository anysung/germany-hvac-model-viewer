...
const EN_T = {
    ...
    socialLoginOnly: "For accounts that already exist. New accounts are created with a company email.",
    socialNoAccount: "No account is registered for this Google or Apple identity.\n\nPlease sign up with your company email first. You can then link Google or Apple sign-in from your Account page.",
    suEmailAdvice: "Use your company email. The account email cannot be changed later — team seats and invoices are tied to it. After signing up you can link Google or Apple sign-in from your Account page.",
...
const DE_T = {
    ...
    socialLoginOnly: "Für bereits bestehende Konten. Neue Konten werden mit einer Firmen-E-Mail angelegt.",
    socialNoAccount: "Für diese Google- oder Apple-Identität ist kein Konto registriert.\n\nBitte registrieren Sie sich zuerst mit Ihrer Firmen-E-Mail. Anschließend können Sie die Google- oder Apple-Anmeldung in Ihrem Konto verknüpfen.",
    suEmailAdvice: "Verwenden Sie Ihre Firmen-E-Mail. Die Konto-E-Mail lässt sich später nicht ändern — Teamplätze und Rechnungen sind damit verknüpft. Nach der Registrierung können Sie die Google- oder Apple-Anmeldung in Ihrem Konto hinzufügen.",
...
const FR_T = {
    ...
    socialLoginOnly: "Pour les comptes déjà existants. Les nouveaux comptes se créent avec un e-mail professionnel.",
    socialNoAccount: "Aucun compte n\u2019est associé à cette identité Google ou Apple.\n\nVeuillez d\u2019abord créer un compte avec votre e-mail professionnel. Vous pourrez ensuite associer la connexion Google ou Apple depuis votre page Compte.",
    suEmailAdvice: "Utilisez votre e-mail professionnel. L\u2019adresse du compte ne peut pas être modifiée par la suite — les sièges d\u2019équipe et les factures y sont rattachés. Après l\u2019inscription, vous pourrez associer la connexion Google ou Apple depuis votre page Compte.",
...
const PL_T = {
    ...
    socialLoginOnly: "Dla istniejących kont. Nowe konta zakłada się firmowym adresem e-mail.",
    socialNoAccount: "Do tej tożsamości Google lub Apple nie jest przypisane żadne konto.\n\nNajpierw załóż konto firmowym adresem e-mail. Następnie w zakładce Konto możesz połączyć logowanie Google lub Apple.",
    suEmailAdvice: "Użyj firmowego adresu e-mail. Adresu konta nie można później zmienić — są z nim powiązane miejsca w zespole i faktury. Po rejestracji w zakładce Konto możesz połączyć logowanie Google lub Apple.",
...
const IT_T = {
    ...
    socialLoginOnly: "Per account già esistenti. I nuovi account si creano con un\u2019e-mail aziendale.",
    socialNoAccount: "Nessun account è registrato per questa identità Google o Apple.\n\nRegistrati prima con la tua e-mail aziendale. Potrai poi collegare l\u2019accesso Google o Apple dalla pagina Account.",
    suEmailAdvice: "Usa la tua e-mail aziendale. L\u2019indirizzo dell\u2019account non può essere modificato in seguito — postazioni del team e fatture sono collegate a questo indirizzo. Dopo la registrazione puoi collegare l\u2019accesso Google o Apple dalla pagina Account.",
